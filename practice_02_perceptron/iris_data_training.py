...
def train(perceptron, X, Y, LR, EPOCHS, RANDOM_STATE, THRESHOLD):

    print(X.shape)

    X = perceptron.fit(X, Y, LR, EPOCHS, RANDOM_STATE, THRESHOLD)
...
if __name__ == "__main__":
    ...
    RANDOM_STATE = 1
    THRESHOLD = 0
    train(perceptron, X, Y, LR, EPOCHS, RANDOM_STATE, THRESHOLD)
